...
void menu1(){
    PlaySound("music\\mainmenu.wav",NULL, SND_FILENAME|SND_LOOP|SND_ASYNC);
    cout<<"\t\t\t\t\t\t########## SUDOKU ##########"<<endl;
...
{
PlaySound("music\\gamenow.wav",NULL, SND_FILENAME|SND_LOOP|SND_ASYNC);
...
{   char name[20];
   ...
   cin>>name;
   fstream file("scores\\scores.txt",ios::in | ios::out | ios::app);
   if(!file.is_open()){
...
void display()
{
PlaySound("music\\scores.wav",NULL, SND_FILENAME|SND_ASYNC);	
fstream fIn;
fIn.open( "scores\\scores.txt", ios::in );
...
default: menu1();
   ...
   case 1:PlaySound("music\\gamenow.wav",NULL, SND_FILENAME|SND_ASYNC);
